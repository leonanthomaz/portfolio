...
export const PortfolioData = [
    {
      ...
      title: "Saturno",
      subtitle: "ChatBox",
      img: "https://leonanthomaz.vercel.app/static/media/img/portfolio/saturno1.png",
  ...
  export const APIListData = [
    {
      id: 1,
      title: "Clapperboard",
      subtitle: "Consumindo API de filmes (TMDB) - Em finalização",
      img: "https://leonanthomaz.vercel.app/src/assets/img/portfolio/clapper2.jpg",
      description: "Sistema de catalogação de filmes, consumindo API TMDB e utilização de Context API e Hooks para renderização de componentes. Está em fase de conclusão (inserção de comentários via MongoDB).",
      date: "Atualmente",
  ...
  export const EstudoListData = [
    {
      ...
      img: "https://leonanthomaz.vercel.app/src/assets/img/portfolio/brasilcovid1.png",
  ...
  export const EcommerceListData = [
    {
      ...
      img: "https://leonanthomaz.vercel.app/src/assets/img/cds1.png",
  ...
  export const PublicidadeListData = [
    ...
    //   title: "Brasil Covid",
    //   subtitle: "API de estatísticas da Covid no Brasil",
    //   img: "https://leonanthomaz.vercel.app/assets/img/clapper2.jpg",
    //   description: "API básica, contendo os números da pandemia do Covid-19 por Estados brasileiros. Neste mini-projeto pude desenvolver ainda mais minhas habilidades com Axios e Hooks.",
    //   date: "Junho 2021",
    //   technology: "React, JavaScript, CSS e HTML5",
    //   url: "https://brasilcovid.herokuapp.com/",
